...
export function AbandonedCartsTable() {
  ...
  const filteredCarts = abandonedCarts.filter((cart) => {
    ...
    const matchesStatus =
      statusFilter === "all" || cart.recoveryStatus === statusFilter;
                ...
                <TableCell>
                  <div className="flex flex-col">
                    ...
                    <span className="text-xs text-muted-foreground">
                      {getTimeElapsed(cart.lastActive)}
                    </span>
                  </div>
                </TableCell>
                <TableCell>
                ...
                <TableCell className="text-right">
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      ...
                      <DropdownMenuItem
                        onClick={() =>
                          handleSendRecoveryEmail(cart.id, cart.customer.email)
                        }
                        disabled={
                          cart.recoveryStatus === "Recovered" ||
                          cart.recoveryStatus === "Email Sent"
                      ...
                      <DropdownMenuItem asChild>
                        <Link
                          href={`/dashboard/customers/${cart.customer.email}`}
                        >
                          <Eye className="mr-2 h-4 w-4" />
                          View customer
                        </Link>
